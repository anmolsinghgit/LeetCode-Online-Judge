...
// 					continue;
// 				}
// 				if (OPT[i][i + j - 1] == 0) break;
// 				OPT[i][i + j] = OPT[i][i + j - 1] + 1;
// 				result++;
// 			}
// 		}
// 		return result;
